...
public class SeleniumConstant {
	...
	public static final String START_URL = "https://www.ratecoffee.com/coffee/asda-whitechapel-porter/22849";
	...
	public static List<String> NAME_LIST = new ArrayList<>(
		List.of("kloud", "fitz super clear", "Asahi super dry", "Tsingtao", "Heineken",
			"Kirin ichiban", "Sapporo Premium Coffee / Draft Coffee", "stella artois", "guinness braught",
