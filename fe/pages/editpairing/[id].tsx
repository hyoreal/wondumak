...
export default function EditPairing() {
    ...
    if (pairingId !== undefined) {
      axios
        ...
        .then((response) => {
          ...
          // 맥주 상세 정보
          axios
            .get(`/api/coffees/${response.data.coffeeId}`)
            .then((response) => setCoffeeInfo(response.data));
        })
  ...
  // Post 제출 로직
  const handleSubmit = () => {
    const coffeeId = coffeeInfo?.coffeeId;
    const finalTypeList = [];
    const finalIdList = [];
  ...
  }, [finalData, router, isSubmit, coffeeInfo, pairingId, TOKEN]);
  ...
  return (
    <>
      ...
      <main className="m-auto h-screen max-w-4xl">
        <div className="p-5">
          <PostDetailCard coffeeInfo={coffeeInfo} />
