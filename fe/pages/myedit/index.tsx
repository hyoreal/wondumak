...
export default function MyEdit() {
  ...
  const onValid = (data: any) => {
    // 기본으로 data 가져오기
    // console.log(data);
    const { nickname, gender, age, userCoffeeCategories, userCoffeeTags } =
      getValues();

    editClick(nickname, gender, age, userCoffeeCategories, userCoffeeTags);
  };
  const onImg = () => {
              ...
              <div>
                ...
                {errors.userCoffeeCategories && (
                  <p className="flex text-xs mx-3 mb-1 gap-0.5 text-red-500">
                    <BiErrorAlt /> {errors.userCoffeeCategories.message}
                  </p>
                )}
              </div>
              <div>
                ...
                {errors.userCoffeeTags && (
                  <p className="flex text-xs  mx-3 mb-1 gap-0.5 text-red-500">
                    <BiErrorAlt /> {errors.userCoffeeTags.message}
                  </p>
                )}
              </div>
              <Link
